...
public class FunctionsStreamIntegrationTests {
    ...
    void whenOrderAcceptedThenDispatched() throws IOException {
        ...
        Message<OrderAcceptedMessage> inputMessage = MessageBuilder
                ...
                .build();
        Message<OrderDispatchedMessage> expecedOutputMessage = MessageBuilder
                .withPayload(new OrderDispatchedMessage(orderId))
                .build();
        this.input.send(inputMessage);
        assertThat(objectMapper.readValue(this.output.receive().getPayload(),
                OrderDispatchedMessage.class))
                .isEqualTo(expecedOutputMessage.getPayload());
    }
}
